...
urlpatterns = [    
    ...
    url(r'^clean_project/(?P<project_id>[0-9]+)$', views.clean_project, name='clean_project'),
    ...
    url(r'^edit_component/(?P<component_id>[A-Za-z0-9.-]+)$', component_views.edit_component, name='edit_component'),
    url(r'^edit_component$', component_views.edit_component, name='edit_component'),
    ...
    url(r'^project/generic_poll_state$', views.generic_poll_state,name='generic_poll_state'),
]
