...
#+LATEX_HEADER: \lstdefinelanguage{bash}{basicstyle=\ttfamily\scriptsize,rulecolor=\color{green},rulesepcolor=\color{mygray},frameround=ffff,backgroundcolor=\color{cyan}}
#+LATEX_HEADER: \lstdefinelanguage{dash}{basicstyle=\ttfamily\scriptsize,rulecolor=\color{green},rulesepcolor=\color{mygray},frameround=ffff,backgroundcolor=\color{yellow}}
#+LATEX_HEADER: \lstdefinelanguage{sh}{basicstyle=\ttfamily\scriptsize,rulecolor=\color{green},rulesepcolor=\color{mygray},frameround=ffff,backgroundcolor=\color{orange}}
...
9. Build the libraries:
    #+BEGIN_SRC dash :results output :eval ask
      echo \
	   'if [[ -e SLAT ]]; then
		cd SLAT/linux
		git pull
    ...
    #+RESULTS:
    : g++ -fPIC -shared -Wl,-soname,_pyslatcore.so `pkg-config --libs python3` `pkg-config --libs gsl` obj/wrap_pyslatcore.o obj/pyslatcore.o -o lib/_pyslatcore.so  -Llib -lslat -lboost_log -lboost_thread -lboost_system -lpthread -lboost_unit_test_framework -lboost_filesystem `pkg-config --libs gsl` -lpthread -fopenmp
    : g++ -c -g -O3 -fopenmp -Wall -Werror -fbounds-check -Warray-bounds -std=gnu++11 -DBOOST_ALL_DYN_LINK `pkg-config --cflags python3` -fPIC `pkg-config --cflags gsl` ../src/example2.cpp -o obj/example2.o
    : g++ -fPIC obj/example2.o -Llib -lslat -o bin/example2 -lboost_log -lboost_thread -lboost_system -lpthread -lboost_unit_test_framework -lboost_filesystem `pkg-config --libs gsl` -lpthread -fopenmp
    : cd ../src && java -jar /usr/local/lib/antlr-4.7-complete.jar -Dlanguage=Python3 -o /home/webslat-user/SLAT/linux/lib slatLexer.g4
    : ../Makefile.common:97: recipe for target 'lib/slatLexer.py' failed
...
22. Create the static files:
    ...
    #+RESULTS:
    #+begin_example
    Copying '/home/webslat-user/webslat-env/lib/python3.5/site-packages/django/contrib/admin/static/admin/img/sorting-icons.svg'
    Copying '/home/webslat-user/webslat-env/lib/python3.5/site-packages/django/contrib/admin/static/admin/img/icon-addlink.svg'
    Copying '/home/webslat-user/webslat-env/lib/python3.5/site-packages/django/contrib/admin/static/admin/img/icon-unknown.svg'
    Copying '/home/webslat-user/webslat-env/lib/python3.5/site-packages/django/contrib/admin/static/admin/img/selector-icons.svg'
    Copying '/home/webslat-user/webslat-env/lib/python3.5/site-packages/django/contrib/admin/static/admin/img/LICENSE'
    Copying '/home/webslat-user/webslat-env/lib/python3.5/site-packages/django/contrib/admin/static/admin/img/icon-calendar.svg'
    Copying '/home/webslat-user/webslat-env/lib/python3.5/site-packages/django/contrib/admin/static/admin/img/gis/move_vertex_off.svg'
    Copying '/home/webslat-user/webslat-env/lib/python3.5/site-packages/django/contrib/admin/static/admin/img/gis/move_vertex_on.svg'

    61 static files copied to '/home/webslat-user/webslat/webslat/static'.
#+end_example
